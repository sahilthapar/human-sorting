...
class TestSortStrings(unittest.TestCase):
  def test_numbers(self):
    ...
    self.assertEqual(sort_strings.sort_strings(numbers), sorted_numbers)
  ...
  def test_money(self):
    ...
    self.assertEqual(sort_strings.sort_strings(money), sorted_money)

  def test_dates(self):
    dates = ['2016-08-01', '2017-01-01', '2010-01-08', '1992-05-06']
    sorted_dates = ['1992-05-06', '2010-01-08', '2016-08-01', '2017-01-01']
    self.assertEqual(sort_strings.sort_strings(dates), sorted_dates)
  ...
  def test_strings(self):
    ...
    self.assertEqual(sort_strings.sort_strings(strings), sorted_strings)

  def test_phone_numbers(self):
    phone_numbers = ['512-513-4400', '512-512-4400', '512-513-3000']
    sorted_phone_numbers = ['512-512-4400', '512-513-3000', '512-513-4400']
    self.assertEqual(sort_strings.sort_strings(phone_numbers), sorted_phone_numbers)
  ...
  def test_ip_addresses(self):
    ...
    self.assertEqual(sort_strings.sort_strings(ip_addresses), sorted_ip_addresses)
  ...
  def test_file_paths(self):
    ...
    self.assertEqual(sort_strings.sort_strings(filepaths), sorted_filepaths)
  ...
  def test_file_names(self):
    ...
    self.assertEqual(sort_strings.sort_strings(filenames), sorted_filenames)

  def test_alphanumeric(self):
    alpha_nums = ['img12.png', 'img10.png', 'img2.png', 'img1.png']
    sorted_alpha_nums = ['img1.png', 'img2.png', 'img10.png', 'img12.png']
    self.assertEqual(sort_strings.sort_strings(alpha_nums), sorted_alpha_nums)
  ...
  def test_alphanumeric_with_dates(self):
    ...
    self.assertEqual(sort_strings.sort_strings(alpha_nums_date), sorted_alpha_nums_date)
  ...
  def test_version(self):
    ...
    self.assertEqual(sort_strings.sort_strings(versions), sorted_versions)
  ...
  def test_version_with_text(self):
    ...
    self.assertEqual(sort_strings.sort_strings(version_with_text), sorted_version_with_text)
  ...
  def test_mixed_bag_1(self):
    ...
    self.assertEqual(sort_strings.sort_strings(mixed_bag), sorted_mixed_bag)
  ...
  def test_empty(self):
    empty = []
    self.assertEqual(sort_strings.sort_strings(empty), empty)
